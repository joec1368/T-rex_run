...
public class nightmare_background extends nightmare_move implements Runnable {
    JFrame frame;
    Canvas canvas;
    ...
    ene_nightmare_top_sky[] enemy_nightmare_top_skies = new ene_nightmare_top_sky[2000];
    ene_nightmare_middle_sky[] enemy_nightmare_middle_sky = new ene_nightmare_middle_sky[2000];
    ene_nightmare_ground[] enemy_nightmare_ground = new ene_nightmare_ground[2000];
    int numberGroundEnemy = 0;
    int numberMiddleSkyEnemy = 0;
    int numberTopSkyEnemy = 0;
    int numberNightmareTopSkyEnemy = 0;
    int numberNightmareMiddleSky = 0;
    int numberNightmareGround = 0;
    ...
    protected void PaintEnemy(Graphics2D g){
        ...
        while (enemy_nightmare_top_skies[temp3] != null) {
            enemy_nightmare_top_skies[temp3].createene(g);
            temp3 ++;
        }while (enemy_nightmare_middle_sky[temp4] != null) {
            enemy_nightmare_middle_sky[temp4].createEne(g);
            temp4 ++;
        }while (enemy_nightmare_ground[temp5] != null) {
            enemy_nightmare_ground[temp5].createEne(g);
            temp5 ++ ;
        }
    }

    protected void enemy() throws InterruptedException {
        switch(RandomNum.randomNumberNightmare(timerBackground.originTime())){
            case 0:
            ...
            case 2:
                ...
                break;
            case 3:
                enemy_nightmare_ground[numberNightmareGround++] = new ene_nightmare_ground();
                break;
            case 4:
                enemy_nightmare_middle_sky[numberNightmareMiddleSky++] = new ene_nightmare_middle_sky();
                break;
            case 5:
                enemy_nightmare_top_skies[numberNightmareTopSkyEnemy++] = new ene_nightmare_top_sky();
                break;
        }
        enemyMove();
    }
    ...
    protected void enemyMove() throws InterruptedException {
        ...
        while (enemy_nightmare_top_skies[temp3] != null && running) {
            running = enemy_nightmare_top_skies[temp3].move();
            enemy_nightmare_top_skies[temp3].getvaluY(myY,myX);
            temp3 ++;
        }
        while (enemy_nightmare_middle_sky[temp4] != null && running) {
            running = enemy_nightmare_middle_sky[temp4].move();
            enemy_nightmare_middle_sky[temp4].getvaluY(myY,myX);
            temp4 ++;
        }
        while (enemy_nightmare_ground[temp5] != null && running) {
            running = enemy_nightmare_ground[temp5].move();
            enemy_nightmare_ground[temp5].getvaluY(myY,myX);
            temp5 ++;
        }
    }
